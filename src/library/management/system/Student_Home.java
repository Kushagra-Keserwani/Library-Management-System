...
public class Student_Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Student_Home(String student_id) {
            ...
            JMenuItem mntmAboutUs = new JMenuItem("Contact Us");
...
//            menuBar.add(mnRecord);
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/eleventh.png"));
            ...
            ImageIcon i16  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/ELib.png"));
